...
The plugin checks `<mountPoint>[/subpath]/<artistName>/artist.nfo`
artistName is checked for case-insensitive, but exactly (no fuzziness)
...
> For example: If your Artist information folder is a folder called `ArtistInfoKodi` inside your library 1, then: Open Navidrome -> Plugins -> artist-nfo-metadata -> Configuration -> Artistfolder Subpath -> Click `+`
